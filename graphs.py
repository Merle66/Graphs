...
#DFS :  G - Dictionary of edges s - Starting Node Vars :  vis - Set of visited nodes
        #pila - Traversal Stack
...
#BFS: G - Dictionary of edges  s - Starting Node
        #Vars :  vis - Set of visited nodes Q - Traversal Stack
